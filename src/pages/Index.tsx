...
// Real WhatsApp icon as inline SVG component
...
// ——— Truck photos: place your 5 images in /public/trucks/ as truck-1.jpg … truck-5.jpg ———
const truckPhotos = [
  "/trucks/truck-1.jpeg",
  "/trucks/truck-2.jpeg",
  "/trucks/truck-3.jpeg",
...
const faqs = [
  { q: "Hangi bölgelere hizmet veriyorsunuz?", a: "Şu anda İstanbul ve çevre illere hizmet veriyoruz. Bulunduğunuz bölge için bizi arayarak bilgi alabilirsiniz." },
  ...
  { q: "Ödeme nasıl yapılır?", a: "Nakit ve banka havalesi kabul ediyoruz. Ödeme, iş tamamlandıktan sonra alınır." },
];
...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero — flush against navbar */}
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      <section className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            {truckPhotos.slice(0, 3).map((src, i) => (
              <div key={i} className="rounded-2xl overflow-hidden border border-border aspect-[4/3]">
                <img src={src} alt={`Kurulumix nakliyat aracı ${i + 1}`} className="w-full h-full object-cover" />
              </div>
            ))}
          </div>
          <div className="grid grid-cols-2 gap-3 md:gap-4 mt-3 md:mt-4 max-w-2xl mx-auto">
            {truckPhotos.slice(3, 5).map((src, i) => (
              <div key={i + 3} className="rounded-2xl overflow-hidden border border-border aspect-[4/3]">
                <img src={src} alt={`Kurulumix nakliyat aracı ${i + 4}`} className="w-full h-full object-cover" />
              </div>
            ))}
          </div>
        </div>
